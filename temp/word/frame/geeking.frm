...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm1 
   ...
   ClientTop       =   456
   ClientWidth     =   13872
   OleObjectBlob   =   "geeking.frx":0000
...
Private Sub UserForm_Initialize()
   ...
   Set db_object = OpenDatabase("E:\\sanad\\otor.accdb")
   Set rst_object = db_object.OpenRecordset("Select ID , SHEIKH_NAME , DEGREE from  [ORDER] WHERE STATE = 'DESIGN' ORDER BY DEGREE")
...
' set student type
    If student_type = False Then
            ...
            replace_text original_text:="æóÈóÚúÏ Ãóäú ÚóáöãóÊõ ãöäúåõ ÇáÏøöÑóÇíóÉö æóÇáÅöÊúŞóÇäö æó ÃØúãóÃúäóäúÊõ Åöáóì ŞöÑóÇÁóÊöåö ßõáøó ÇáÅØúãöÆúäóÇä", new_text:="æóÈóÚúÏ Ãóäú ÚóáöãóÊõ ãöäúåÇ ÇáÏøöÑóÇíóÉö æóÇáÅöÊúŞóÇäö æó ÃØúãóÃúäóäúÊõ Åöáóì ŞöÑóÇÁóÊöåÇ ßõáøó ÇáÅØúãöÆúäóÇäö"
            ...
            replace_text original_text:="İóÍóÇİöÙõ Ãöíå ÇáãõÌóÇÒõ Úóáóì ãóÇ ÃóÏøóíúÊõåõ áóßó ÌóÚóáóß", new_text:="İóÍóÇİöÙö ÃöíÊåÇ ÇáãõÌóÇÒÉ Úóáóì ãóÇ ÃóÏøóíúÊõåõ áóßó ÌóÚóáóß"
...
Private Sub ComboBox1_Change()
   ...
   Set rst_object = db_object.OpenRecordset("Select CONTENT.ID , CONTENT.STUDENT_NAME , CONTENT.QERAA from  CONTENT , [ORDER] WHERE  CONTENT.ORDER_ID = [ORDER].ID AND TYPE = 'EJAZA' AND [ORDER].SHEIKH_NAME = '" & Split(ComboBox1.Value, "-")(1) & "'")
   ListBox1.Clear
      Do Until rst_object.EOF
...
Private Sub DB_ejaza_creator(ejaza_id As String)
   ...
   Set db = OpenDatabase("E:\\sanad\\otor.accdb")
