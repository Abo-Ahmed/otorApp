...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm1 
   ...
   ClientTop       =   456
   ClientWidth     =   9816
   OleObjectBlob   =   "database_nes.frx":0000
...
Private Sub CommandButton5_Click()
   ...
   Set db_order = OpenDatabase(strDB)
   
   strSQL = "Select EJAZA.ID from EJAZA , CONTENT where CONTENT.ID = EJAZA.CONTENT_ID and CONTENT.ORDER_ID = " & general_id
   
     
   Set rst_order = db_order.OpenRecordset(strSQL)
    ...
    End If
      ...
      Do Until rst_order.EOF
        MsgBox ("FOUND ID: " & rst_order.Fields("EJAZA_ID"))
        rst.MoveNext
       Loop
