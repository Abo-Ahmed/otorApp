...
Function qeraatn(index As Integer) As String
        ...
        'adding sanad
        If index = -1 Then
        qeraatn = "ָÞֱַַׁÊ ֳוב ַבÊז׃״ ( ַָה Úַדׁ ז Úַױד ז ַבß׃ֶַל ז ־בÝ ) דה ״ׁםÞ ַבװַ״ָםֹ ז ַבֹֿׁ"
          
        ElseIf index = -2 Then
        qeraatn = "ָÞֱַֹׁ ַבָױׁםַה ( ֳָז Úדׁז ז םÚÞזָ ) דה ״ׁםÞ ַבװַ״ָםֹ ז ַבֹֿׁ"
