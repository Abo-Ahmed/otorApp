...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm1 
   ...
   ClientTop       =   456
   ClientWidth     =   11568
   OleObjectBlob   =   "wow_form.frx":0000
...
Private Sub CommandButton5_Click()
   ...
   strDB = "E:\\other\\otor.accdb"  'Change it to your database name
   Set db = OpenDatabase(strDB)
   
   
   ejaza_id = InputBox("ֳֿ־ב דÚׁÝ ַבֵַֹּׂ")
   ...
   If rst.RecordCount > 0 Then
      ...
      TAREQ = rst.Fields("TAREQ")
      STATE = rst.Fields("STATE")
      If (rst.Fields("STUDENT_GENDER") = "״ַבָ") Then
        GENDER = True
      Else
        GENDER = False
      End If
      
      MsgBox (NAME & vbNewLine & INFO & vbNewLine & rst.Fields("STUDENT_GENDER") & vbNewLine & QERAA & vbNewLine & TAREQ & vbNewLine & STATE)
   Else
      MsgBox ("דÚׁÝ ַבֵַֹּׂ Ûםׁ דזּזֿ")
   End If
...
Private Sub OptionButton3_Click()
 TextBox3.text = "דÞֶׁ זדÚבד ַבÞֲׁה ַבßׁםד זַבÊּזםֿ"
 
 
End Sub

Private Sub OptionButton4_Click()
 TextBox3.text = "דÞֶֹׁ זדÚבדֹ ַבÞֲׁה ַבßׁםד זַבÊּזםֿ"
End Sub
