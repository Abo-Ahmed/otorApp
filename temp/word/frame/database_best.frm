...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm1 
   ...
   ClientTop       =   456
   ClientWidth     =   14304
   OleObjectBlob   =   "database_best.frx":0000
...
Dim db_order As DAO.Database
   ...
   Set rst_order = db_order.OpenRecordset("Select ID , SHEIKH_NAME , DEGREE from  [ORDER] ORDER BY DEGREE")
...
Private Sub ComboBox1_Change()
   ...
   Set rst_order = db_order.OpenRecordset("Select CONTENT.ID , CONTENT.STUDENT_NAME , CONTENT.QERAA from  CONTENT , [ORDER] WHERE  CONTENT.ORDER_ID = [ORDER].ID AND [ORDER].SHEIKH_NAME = '" & Split(ComboBox1.Value, "-")(1) & "'")
